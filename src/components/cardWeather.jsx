...
export const CardWeather = ({ main, name, sys, wind, weather,onSearch }) => {
	return (
			...
			<div className="relative flex w-72 flex-col items-center overflow-hidden rounded-3xl bg-blue-400 p-6">
				...
				<div className="z-10 w-full">
					...
					<div className="flex w-full flex-col items-center relative">
						...
						<p className="text-white text-sm">{weather[0].main}</p>
						<p className="text-xs text-white ">{weather[0].description}</p>
					</div>
					<div className="mt-10 flex w-full justify-between text-sm text-blue-50">
						<div className="flex flex-col items-center justify-center space-y-1">
							<p className="text-xs">Wind Speed</p>
							<p>
								<span className="text-xl font-bold mr-1 ">{wind.speed}</span>km
							</p>
						</div>
						<div className="flex flex-col items-center justify-center space-y-1">
							<p className="text-xs">Humidity</p>
							<p>
								<span className="text-xl font-bold mr-1">{main.humidity}</span>%
							</p>
						</div>
						<div className="flex flex-col items-center justify-center space-y-1">
							<p className="text-xs">Precipitation</p>
							<p>
								<span className="text-xl font-bold mr-1">81</span>%
							</p>
						</div>
					</div>
				</div>
